        ...
        <div class="movie-slider">
          <div class="movie-track">
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage.png" alt="Movie 1">
              <div class="hover-overlay">
                <a href="trailer1-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie1" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage2.png" alt="Movie 2">
              <div class="hover-overlay">
                <a href="trailer2-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie2" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              ...
              <div class="hover-overlay">
                ...
                <p id="umovie3" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage4.png" alt="Movie 4">
              <div class="hover-overlay">
                <a href="trailer4-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie4" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage5.png" alt="Movie 5">
              <div class="hover-overlay">
                <a href="trailer5-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie5" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage6.png" alt="Movie 6">
              <div class="hover-overlay">
                <a href="trailer6-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie6" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage7.png" alt="Movie 7">
              <div class="hover-overlay">
                <a href="trailer7-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie7" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
            <div class="movie-item">
              <img src="C:\Users\nadee\Downloads\testimage2.png" alt="Movie 8">
              <div class="hover-overlay">
                <a href="trailer8-link" class="watch-trailer-btn">Watch Trailer</a>
                <p id="umovie8" class="movie-name">KRAVEN THE HUNTER</p>
                <p class="release-date">In theaters Dec 06, 2024</p>
              </div>
            </div>
          </div>
