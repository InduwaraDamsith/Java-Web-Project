...
<body>
    ...
    <section class="about-section">
        <div class="content-container">
            ...
            <p class="description">
                Dedicated toward raising the bar in Sri Lanka’s cinema experience, Scope aims to provide our patrons with all the flare of old-school movie theaters, coupled with state-of-the-art modernity and comfort, consistent with international standards.
            </p>
